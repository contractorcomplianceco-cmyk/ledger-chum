...
export type UserStatus =
  "invited" | "active" | "suspended" | "locked" | "deactivated" | "pending_review";
...
export type PermissionScope =
  "own" | "assigned" | "department" | "company" | "all" | "sensitive_masked" | "sensitive_visible";
...
export interface AdminService {
  ...
  inviteUser(
    input: Partial<AdminUser> & { email: string; name: string },
  ): Promise<DemoResult<AdminUser>>;
...
const MOCK_ROLES: AdminRole[] = [
  {
    key: "owner",
    name: "Owner",
    description: "Final override on cash, guardrails, pricing.",
    builtin: true,
    memberCount: 1,
    permissions: ["*"],
  },
  {
    ...
    description: "Reclassifications, approvals, verification.",
    builtin: true,
    memberCount: 1,
    permissions: [
      "invoices.*",
  ...
  },
  {
    ...
    description: "Attestation and audit — never posts value.",
    builtin: true,
    memberCount: 1,
    permissions: ["*.view", "audit.*", "integrations.*"],
  },
  {
    key: "accountant",
    name: "Accountant / Tax Advisor",
    description: "Day-to-day ledger operator; bounded approval limits.",
    builtin: true,
    memberCount: 0,
    permissions: ["ledger.*", "reports.*", "commissions.view"],
  },
  {
    key: "team_member",
    name: "Team Member",
    description: "Submit and view own scope.",
    builtin: true,
    memberCount: 12,
    permissions: ["expenses.submit", "expenses.view.own", "commissions.view.own"],
  },
  {
    key: "integration_service",
    name: "Integration Service",
    description: "Signed events only; no interactive login.",
    builtin: true,
    memberCount: 6,
    permissions: ["events.ingest", "sync.*"],
  },
];
...
const PERMISSION_ENTRIES: PermissionEntry[] = [
  {
    ...
    group: "Users",
    label: "View users",
    scopes: ["own", "department", "company"],
  },
  {
    key: "users.manage",
    group: "Users",
    label: "Invite / suspend / deactivate users",
    scopes: ["company"],
  },
  { key: "roles.manage", group: "Roles", label: "Create and edit roles", scopes: ["company"] },
  {
    key: "banking.view",
    group: "Banking",
    label: "View bank accounts and balances",
    scopes: ["sensitive_masked", "sensitive_visible"],
  },
  {
    key: "banking.reconcile",
    group: "Banking",
  ...
  {
    key: "commissions.verify",
    group: "Commissions",
    label: "Verify commission calculations",
    scopes: ["company"],
  },
  {
    key: "commissions.approve",
    group: "Commissions",
    label: "Approve commission payables",
    scopes: ["company"],
  },
  {
    key: "commissions.override",
    group: "Commissions",
    label: "Override commission rules",
    scopes: ["company"],
  },
  {
    key: "reports.view",
    group: "Reports",
    label: "View reports and exports",
    scopes: ["department", "company"],
  },
  {
  ...
  },
  {
    key: "ai.query",
    group: "AI",
    label: "Query LedgerOS Intelligence",
    scopes: ["department", "company"],
  },
...
const MOCK_SESSIONS: AdminSession[] = [
  {
    ...
    lastSeenAt: "2026-07-12T13:45:00Z",
    active: true,
  },
  {
    id: "s_2",
    ...
    startedAt: "2026-07-12T07:40:00Z",
    lastSeenAt: "2026-07-12T13:12:00Z",
    active: true,
  },
];
...
const MOCK_SECURITY: SecurityEvent[] = [
  {
    ...
    at: "2026-07-11T22:14:00Z",
    ip: "192.0.2.55",
    severity: "warning",
    detail: "3 failed attempts, MFA not enrolled",
  },
  {
    id: "sec_2",
    ...
    severity: "info",
    detail: "Granted commissions.approve to accounting_lead role",
  },
];
...
const MOCK_SERVICE_ACCOUNTS: ServiceAccount[] = [
  {
    id: "sa_1",
    name: "Zoho CRM Sync",
    scope: "events.ingest, customers.read",
    createdBy: "Rose",
    createdAt: "2026-01-04T10:00:00Z",
    lastUsedAt: "2026-07-12T09:00:00Z",
    active: true,
  },
  {
    id: "sa_2",
    name: "Navy Federal Importer",
    scope: "banking.import",
    createdBy: "Christin",
    createdAt: "2026-02-14T10:00:00Z",
    lastUsedAt: "2026-07-12T04:00:00Z",
    active: true,
  },
];
...
export const mockAdmin: AdminService = {
  ...
  listAudit: () =>
    mockGet(() => [
      ...
      {
        id: "aud_u_2",
        type: "role.permission_added",
        actor: "Rose",
        at: "2026-07-05T09:00:00Z",
        summary: "commissions.approve → accounting_lead",
      },
    ]),
};
