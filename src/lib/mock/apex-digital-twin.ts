...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    inputs: {
      ...
      headcountDelta: 0,
      payrollDelta: 0,
      marketingDelta: 25000,
      techDelta: 0,
      benefitsDelta: 0,
      taxReserveDelta: -10000,
      ownerDistributionDelta: -30000,
    },
    outputs30: shift(-4),
    outputs90: shift(-14),
...
function shift(pct: number): ScenarioOutputs {
  ...
  return {
    ...
    financialConfidence: Math.max(
      30,
      Math.min(99, Math.round(BASELINE.financialConfidence + pct / 3)),
    ),
