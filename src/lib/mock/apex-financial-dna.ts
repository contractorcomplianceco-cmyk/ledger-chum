...
export const DNA_NODES: DnaNode[] = [
  {
    ...
    confidence: 99,
    auditStatus: "posted",
    explanation: "Origin client of this cash flow.",
    parents: [],
    children: ["n2"],
  ...
  },
  {
    ...
    confidence: 95,
    auditStatus: "posted",
    explanation: "Master agreement governing this engagement.",
    parents: ["n1"],
    children: ["n3"],
  },
  {
    id: "n3",
    label: "Compliance Audit — Q2",
    stage: "Service",
    amount: 100000,
    pctOfOrigin: 100,
    classification: "available",
    ...
    confidence: 96,
    auditStatus: "posted",
    explanation: "Delivered service tied to this payment.",
    parents: ["n2"],
    children: ["n4"],
  },
  {
    ...
    confidence: 99,
    auditStatus: "posted",
    explanation: "Invoice issued 05/01.",
    parents: ["n3"],
    children: ["n5"],
    relatedTimeline: "TL-INVOICE-0501",
  },
  {
    id: "n5",
    ...
    confidence: 99,
    auditStatus: "posted",
    explanation: "Wire received 05/12.",
    parents: ["n4"],
    children: ["n6", "n7"],
  },
  {
    id: "n6",
    label: "Vendor Pass-Through",
    stage: "Pass-Through",
    amount: 18000,
    pctOfOrigin: 18,
    ...
    confidence: 97,
    auditStatus: "posted",
    explanation: "Reserved to pay upstream vendor. Not company revenue.",
    parents: ["n5"],
    children: ["n13"],
  },
  {
    ...
    confidence: 98,
    auditStatus: "posted",
    explanation: "Payment net of pass-through.",
    parents: ["n5"],
    children: ["n8", "n9", "n10", "n11", "n12"],
  },
  {
    id: "n8",
    label: "GTM Commission",
    stage: "Commission",
    amount: 8200,
    pctOfOrigin: 8.2,
    ...
    confidence: 92,
    auditStatus: "review",
    explanation: "10% of realized revenue.",
    parents: ["n7"],
    children: ["n14"],
  },
  {
    id: "n9",
    label: "Delivery Payroll",
    stage: "Payroll",
    amount: 22400,
    pctOfOrigin: 22.4,
    classification: "reserved",
    ...
    confidence: 94,
    auditStatus: "posted",
    explanation: "Loaded labor cost for delivery team.",
    parents: ["n7"],
    children: ["n14"],
  },
  {
    id: "n10",
    label: "Tech Allocation",
    stage: "Technology",
    amount: 3200,
    pctOfOrigin: 3.2,
    classification: "reserved",
    ...
    confidence: 86,
    auditStatus: "posted",
    explanation: "Allocated SaaS + infra.",
    parents: ["n7"],
    children: ["n14"],
  },
  {
    ...
    confidence: 80,
    auditStatus: "posted",
    explanation: "Attributed acquisition cost.",
    parents: ["n7"],
    children: ["n14"],
  },
  {
    ...
    confidence: 88,
    auditStatus: "posted",
    explanation: "Allocated G&A.",
    parents: ["n7"],
    children: ["n14"],
  },
  {
    id: "n13",
    label: "Vendor Payment — Brightpath",
    stage: "Direct Cost",
    amount: 18000,
    pctOfOrigin: 18,
    ...
    confidence: 97,
    auditStatus: "posted",
    explanation: "Paid to upstream vendor.",
    parents: ["n6"],
    children: [],
  },
  {
    ...
    confidence: 91,
    auditStatus: "review",
    explanation: "Realized revenue − delivery costs.",
    parents: ["n8", "n9", "n10", "n11", "n12"],
    children: ["n15", "n16", "n17"],
  },
  {
    id: "n15",
    label: "Tax Reserve",
    ...
    confidence: 90,
    auditStatus: "posted",
    explanation: "22% of contribution profit reserved for taxes.",
    parents: ["n14"],
    children: [],
  ...
  },
  {
    ...
    confidence: 88,
    auditStatus: "review",
    explanation: "10% of contribution profit to team pool.",
    parents: ["n14"],
    children: [],
  },
  {
    id: "n17",
    label: "Retained + Owner Path",
    stage: "Retained Earnings",
    amount: 26520,
    pctOfOrigin: 26.52,
    classification: "available",
    source: "Derived",
    ...
    confidence: 92,
    auditStatus: "review",
    explanation: "Remaining flows to retained earnings and owner distribution.",
    parents: ["n14"],
    children: ["n18"],
  },
  {
    ...
    confidence: 90,
    auditStatus: "posted",
    explanation: "Scheduled quarterly owner draw.",
    parents: ["n17"],
    children: [],
  },
];
