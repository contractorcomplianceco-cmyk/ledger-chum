...
export const APEX_PRIORITIES: ExecPriority[] = [
  { id: "p1", title: "Review Q2 Forecast", due: "Today · 10:00 AM", severity: "High", owner: "Rose Taylor", route: "/apex/digital-twin", impact: "$1.2M revenue plan" },
  { id: "p2", title: "Approve Compensation Run", due: "Today · 2:00 PM", severity: "High", owner: "Rose Taylor", route: "/compensation", impact: "$142K" },
  { id: "p3", title: "Vendor Contract Renewal — CloudCore", due: "Tomorrow", severity: "Medium", owner: "COO", route: "/automation", impact: "$96K/yr" },
  { id: "p4", title: "Marketing Budget Review", due: "Wed", severity: "Medium", owner: "CMO", route: "/apex/opportunities" },
  { id: "p5", title: "Board Package Review", due: "Thu · 3:00 PM", severity: "Medium", owner: "Rose Taylor", route: "/apex/briefing" },
  { id: "p6", title: "Texas Expansion Analysis", due: "Fri", severity: "Low", owner: "Growth Lead", route: "/apex/opportunities", impact: "+$220K ARR" },
];

export const APEX_QUICK_ACTIONS = [
  { id: "invoice", label: "New Invoice", icon: FileText, tint: "from-blue-500 to-cyan-500", route: "/invoicing" },
  { id: "expense", label: "Record Expense", icon: Receipt, tint: "from-violet-500 to-fuchsia-500", route: "/expenses" },
  { id: "report", label: "Run Report", icon: Package, tint: "from-teal-500 to-emerald-500", route: "/intelligence" },
  { id: "check", label: "Write Check", icon: Wallet, tint: "from-orange-500 to-amber-500", route: "/banking" },
  { id: "transfer", label: "Transfer Funds", icon: Repeat, tint: "from-sky-500 to-indigo-500", route: "/cash-availability" },
  { id: "vendor", label: "Add Vendor", icon: ShoppingBag, tint: "from-rose-500 to-pink-500", route: "/automation" },
];
...
export const APEX_TIMELINE: TimelineEvent[] = [
  { id: "t1", title: "Invoice Paid", supporting: "ALD Compliance Audit", amount: "+$12,500", date: "Jul 10", status: "Completed", icon: Banknote, tone: "cash", route: "/invoicing" },
  { id: "t2", title: "Compensation Run", supporting: "July commissions", amount: "$142K", date: "Jul 15", status: "Scheduled", icon: Users, tone: "attention", route: "/compensation" },
  { id: "t3", title: "Payroll Run", supporting: "Bi-weekly cycle", amount: "$186K", date: "Jul 16", status: "Scheduled", icon: PiggyBank, tone: "neutral", route: "/compensation" },
  { id: "t4", title: "Tax Payment", supporting: "Q2 federal estimated", amount: "$78K", date: "Jul 20", status: "Scheduled", icon: Landmark, tone: "attention", route: "/banking" },
  { id: "t5", title: "Board Meeting", supporting: "Quarterly review", date: "Jul 24", status: "Scheduled", icon: ShieldCheck, tone: "growth", route: "/apex/briefing" },
  { id: "t6", title: "Profit Share", supporting: "Team distribution", amount: "$96K", date: "Jul 31", status: "Pending", icon: Sparkles, tone: "profit", route: "/compensation" },
  { id: "t7", title: "Investor Payout", supporting: "Convertible interest", amount: "$54K", date: "Aug 5", status: "Pending", icon: Plane, tone: "profit", route: "/banking" },
  { id: "t8", title: "Campaign Renewal", supporting: "Campaign 18 continuation", amount: "$42K", date: "Aug 10", status: "Pending", icon: Megaphone, tone: "growth", route: "/apex/opportunities" },
];
