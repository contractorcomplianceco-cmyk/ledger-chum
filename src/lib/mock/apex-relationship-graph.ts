...
export const GRAPH_NODES: GraphNode[] = [
  { id: "campaign:q1", type: "campaign", label: "Q1 Finance Ops Campaign", x: 60, y: 60, amount: 24000 },
  { id: "client:ald", type: "client", label: "ALD Holdings", x: 220, y: 90, amount: 100000, risk: "low", relatedTimeline: "TL-CLIENT-ALD", relatedDna: "DNA-CLIENT-ALD" },
  { id: "client:northstar", type: "client", label: "NorthStar Systems", x: 220, y: 220, amount: 240000, risk: "medium", relatedTimeline: "TL-CLIENT-NORTHSTAR", relatedOpportunity: "OPP-1044" },
  { id: "client:kestrel", type: "client", label: "Kestrel Bio", x: 220, y: 340, amount: 84000, risk: "low", relatedOpportunity: "OPP-1051" },
  { id: "client:sequoia", type: "client", label: "Sequoia Labs", x: 220, y: 450, amount: 38400, risk: "high", relatedOpportunity: "OPP-1047" },
  { id: "contract:ald-msa", type: "contract", label: "MSA #2024-08", x: 380, y: 60, amount: 400000 },
  { id: "service:audit", type: "service", label: "Compliance Audit", x: 380, y: 130 },
  { id: "invoice:0501", type: "invoice", label: "INV-2025-0501", x: 520, y: 90, amount: 100000, status: "paid" },
  { id: "invoice:0311", type: "invoice", label: "INV-2025-0311", x: 520, y: 450, amount: 38400, status: "overdue", risk: "high" },
  { id: "payment:ald-05", type: "payment", label: "Payment 05/12", x: 660, y: 90, amount: 100000 },
  { id: "vendor:brightpath", type: "vendor", label: "Brightpath Media", x: 660, y: 200, amount: 18000 },
  { id: "vendor:notion", type: "vendor", label: "Notion Labs", x: 60, y: 250, amount: 4620, relatedOpportunity: "OPP-1043" },
  { id: "expense:travel-q1", type: "expense", label: "Q1 Conference Travel", x: 60, y: 340, amount: 2840, relatedOpportunity: "OPP-1052" },
  { id: "employee:kchen", type: "employee", label: "K. Chen", x: 660, y: 340, owner: "AR" },
  { id: "commission:c-0501", type: "commission", label: "Commission on INV-0501", x: 520, y: 260, amount: 8200 },
  ...
  { id: "decision:reserve", type: "decision", label: "Tax reserve top-up", x: 380, y: 450, relatedOpportunity: "OPP-1048" },
];
