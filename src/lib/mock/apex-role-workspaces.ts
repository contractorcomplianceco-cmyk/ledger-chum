...
export const ROLE_WORKSPACES: Record<RoleKey, RoleWorkspace> = {
  rose: {
    ...
    metrics: [
      {
        ...
        delta: "+$142K",
        tone: "up",
        hint: "After obligations & reserves",
      },
    ...
    priorities: [
      {
        title: "Approve Q4 expansion plan",
        detail: "New market pilot — $340K allocated, 6-month payback modeled.",
        urgency: "high",
        requiresApproval: true,
      },
      {
        title: "Review runway scenarios",
        detail: "Digital Twin suggests hire pause improves runway by 3.2 months.",
        urgency: "medium",
      },
      {
        title: "Board briefing draft",
        detail: "AI Executive Advisor prepared narrative — awaiting your review.",
        urgency: "medium",
      },
    ],
    recommendations: [
      {
        title: "Fund expansion pilot",
        rationale: "Positive unit economics; 92% modeled confidence.",
        impact: "+$1.1M ARR (12mo)",
        confidence: 0.82,
        approval: "Owner sign-off",
      },
      {
        title: "Hire 2 revenue engineers",
        rationale: "Backlog exceeds delivery capacity by 34%.",
        impact: "Recover $220K/qtr in leaked pipeline",
        confidence: 0.71,
        approval: "Owner + Sales lead",
      },
    ],
    risks: [
      {
        ...
        category: "Revenue",
        severity: "medium",
        detail: "Top 3 clients = 41% of MRR. Diversify or contract-secure.",
      },
      {
        title: "Vendor spend drift",
        category: "Cost",
        severity: "low",
        detail: "SaaS spend +14% QoQ without headcount growth.",
      },
      {
        title: "AP aging bulge",
        category: "Cash",
        severity: "medium",
        detail: "$68K aging 45-60 days — review payment sequencing.",
      },
    ],
    opportunities: [
      {
        title: "Renegotiate top vendor tier",
        category: "Cost",
        potential: "$38K/yr",
        detail: "Volume threshold now supports enterprise tier discount.",
      },
      {
        title: "Repackage service bundles",
        category: "Revenue",
        potential: "$210K/yr",
        detail: "Pricing model shows 18% margin lift on bundled offering.",
      },
    ],
    advisor: {
      ...
      summary:
        "Cash healthy, growth accelerating. Two decisions gate the quarter: expansion pilot approval and hiring sequence.",
  ...
  accounting: {
    ...
    priorities: [
      {
        title: "Resolve 24 banking exceptions",
        detail: "8 auto-suggested matches ready for review.",
        urgency: "high",
      },
      {
        title: "Reconcile operating account",
        detail: "$412 variance — likely timing on 2 vendor payments.",
        urgency: "high",
      },
      {
        title: "Verify commission calculations",
        detail: "3 attribution reviews awaiting sign-off.",
        urgency: "medium",
      },
    ],
    recommendations: [
      {
        title: "Auto-apply 8 high-confidence matches",
        rationale: "≥95% confidence across all 8 suggested matches.",
        impact: "Clear 8 exceptions",
        confidence: 0.96,
        approval: "Controller review",
      },
      {
        title: "Extend pass-through reserve",
        rationale: "Reserve trending 6% below policy floor.",
        impact: "Restore compliance buffer",
        confidence: 0.88,
        approval: "Accounting lead",
      },
    ],
    risks: [
      {
        ...
        category: "Ledger",
        severity: "medium",
        detail: "12 vendor records missing tax classification.",
      },
      {
        title: "Tax calendar item due",
        category: "Compliance",
        severity: "medium",
        detail: "State filing due in 9 days.",
      },
      {
        title: "Audit trail gap",
        category: "Governance",
        severity: "low",
        detail: "2 journal entries missing supporting document link.",
      },
    ],
    opportunities: [
      {
        title: "Reduce close cycle by 2 days",
        category: "Process",
        potential: "16 hrs/mo saved",
        detail: "Automating exception routing pattern from prior close.",
      },
    ],
    advisor: {
      ...
      summary:
        "Close is on track. Exception queue is the critical path — clear high-confidence matches first.",
  ...
  sales: {
    ...
    priorities: [
      {
        title: "Review $340K stalled deals",
        detail: "5 opportunities aged 60+ days in negotiation stage.",
        urgency: "high",
      },
      {
        title: "Approve Q4 pricing pilot",
        detail: "Bundle test shows +18% attach rate.",
        urgency: "medium",
        requiresApproval: true,
      },
      {
        title: "Attribution disputes",
        detail: "2 deals with contested credit assignment.",
        urgency: "medium",
      },
    ],
    recommendations: [
      {
        title: "Raise floor price on Tier 2",
        rationale: "Discount overrides drove $18K leak in 30d.",
        impact: "Recover ~$60K/qtr",
        confidence: 0.79,
        approval: "Sales lead + Owner",
      },
      {
        title: "Focus renewals on top 10 accounts",
        rationale: "84% of renewal revenue concentrated there.",
        impact: "Protect $1.2M ARR",
        confidence: 0.9,
        approval: "Sales lead",
      },
    ],
    risks: [
      {
        title: "Top-account renewal risk",
        category: "Revenue",
        severity: "high",
        detail: "Client A signals procurement review.",
      },
      {
        title: "Attribution conflicts",
        category: "Compensation",
        severity: "medium",
        detail: "2 open disputes could shift $12K in commissions.",
      },
    ],
    opportunities: [
      {
        ...
        category: "Pricing",
        potential: "$210K/yr",
        detail: "Higher-margin bundle tested successfully with 3 accounts.",
      },
      {
        title: "Expand Client B footprint",
        category: "Expansion",
        potential: "$88K ARR",
        detail: "Usage exceeds tier — upgrade motion warranted.",
      },
    ],
    advisor: {
      ...
      summary:
        "Discount overrides on Tier 2 are the largest current leak. Top-account renewal risk is the biggest exposure.",
  ...
  operations: {
    ...
    priorities: [
      {
        title: "Recover $18K stuck invoice",
        detail: "Client B — 42 days aged, response received today.",
        urgency: "high",
      },
      {
        title: "Clear vendor issue #V-217",
        detail: "Duplicate invoice from vendor — dispute drafted.",
        urgency: "medium",
      },
      {
        title: "Onboard 2 new clients",
        detail: "Delivery kickoff scheduled Thursday.",
        urgency: "medium",
      },
    ],
    recommendations: [
      {
        title: "Auto-assign exception queue",
        rationale: "Owner workload skewed 3:1 vs teammates.",
        impact: "Cut resolution time 28%",
        confidence: 0.83,
        approval: "Ops lead",
      },
      {
        title: "Retire manual sync job",
        rationale: "Superseded by native integration 60 days ago.",
        impact: "Free 4 hrs/wk",
        confidence: 0.92,
        approval: "Ops lead",
      },
    ],
    risks: [
      {
        ...
        category: "Process",
        severity: "medium",
        detail: "Backlog +18% vs 30d avg.",
      },
      {
        title: "Integration flakiness",
        category: "Technology",
        severity: "low",
        detail: "3 retries this week on billing sync.",
      },
    ],
    opportunities: [
      {
        title: "Batch reimbursement processing",
        category: "Automation",
        potential: "6 hrs/wk",
        detail: "Group weekly instead of daily.",
      },
    ],
    advisor: {
      ...
      summary:
        "Two bottlenecks: exception queue skew and vendor dispute. Both have clear resolution paths.",
  ...
  systems: {
    ...
    priorities: [
      {
        title: "Review vendor tax-class gaps",
        detail: "12 vendor records missing classification.",
        urgency: "medium",
      },
      {
        title: "Rotate expiring API credential",
        detail: "Integration X credential expires in 6 days.",
        urgency: "high",
      },
      {
        title: "Review AI usage cost curve",
        detail: "Trending 12% above prior 30-day baseline.",
        urgency: "low",
      },
    ],
    recommendations: [
      {
        title: "Add retry-with-backoff on billing sync",
        rationale: "3 retries/week — cheap resilience win.",
        impact: "Reduce sync failure risk",
        confidence: 0.9,
        approval: "Systems lead",
      },
      {
        title: "Enable SSO enforcement for admin",
        rationale: "Best-practice hardening — currently optional.",
        impact: "Reduce credential-risk surface",
        confidence: 0.95,
        approval: "Systems lead + Owner",
      },
    ],
    risks: [
      {
        ...
        category: "Security",
        severity: "high",
        detail: "Rotation window closes in 6 days.",
      },
      {
        title: "Technical debt in sync job",
        category: "Reliability",
        severity: "medium",
        detail: "Legacy job scheduled for retirement.",
      },
    ],
    opportunities: [
      {
        title: "Consolidate 2 overlapping tools",
        category: "Cost",
        potential: "$8K/yr",
        detail: "Overlap in monitoring stack — vendor bake-off ready.",
      },
    ],
    advisor: {
      ...
      summary:
        "Credential rotation is time-sensitive. Data quality is trending up — keep momentum on vendor classification cleanup.",
  ...
  team: {
    ...
    priorities: [
      {
        title: "Submit last week's expenses",
        detail: "3 receipts scanned — waiting on submission.",
        urgency: "medium",
      },
      {
        title: "Complete security training",
        detail: "Due Friday — 25 minutes.",
        urgency: "medium",
      },
      {
        title: "Review compensation statement",
        detail: "Latest statement ready to view.",
        urgency: "low",
      },
    ],
    recommendations: [],
    ...
    advisor: {
      ...
      summary:
        "Two things: submit pending expenses and finish security training. Everything else is on track.",
