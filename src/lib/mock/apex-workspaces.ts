...
export const MONEY_WORKSPACE: WorkspaceDefinition = {
  ...
  metrics: [
    {
      ...
      delta: "+3.2%",
      tone: "up",
      hint: "After reserves & obligations",
    },
  ...
  sections: [
    {
      id: "cash-pulse",
      title: "Cash Pulse™",
      value: "$2.41M available",
      caption: "3 pods — Operating · Reserve · Growth",
    },
    {
      id: "revenue",
      title: "Revenue",
    ...
    },
    {
      ...
      title: "Payables",
      value: "$318K due 7d",
      caption: "82 open bills, 6 awaiting approval",
    },
    { id: "forecast", title: "Cash Forecast", value: "$3.02M in 30d", caption: "Confidence 91%" },
    {
      ...
      title: "Banking",
      value: "9 accounts",
      caption: "All reconciled through yesterday",
    },
    {
      id: "check-writing",
      title: "Check Writing",
      value: "12 pending",
      caption: "Batch cutoff 4:00 PM",
    },
    ...
    { id: "reserved", title: "Reserved Funds", value: "$640K", caption: "Tax · Payroll · Buffer" },
    {
      ...
      title: "Pass-Through",
      value: "$118K",
      caption: "3 client escrows active",
    },
    {
      id: "allocation",
      title: "Revenue Allocation",
      value: "3 rules live",
      caption: "Auto-splitting on deposit",
    },
    {
      id: "profit-sharing",
      title: "Profit Sharing",
      value: "$74K accrued",
      caption: "Q3 pool building",
    },
    {
      id: "investor",
      title: "Investor Distribution",
      value: "$220K scheduled",
      caption: "Sept 30 · 4 partners",
    },
  ...
  timeline: [
    ...
    { when: "09:15", label: "Bill queued", detail: "AWS — $12,410", tone: "neutral" },
    {
      ...
      detail: "Duplicate Adobe seats — $1,180",
      tone: "warning",
    },
  ...
  insights: [
    { label: "Runway sensitivity", detail: "A $50K/mo overhead cut extends runway by 0.6 months." },
    {
      ...
      detail: "Delaying non-strategic bills 5 days preserves $92K in float.",
    },
...
export const GROWTH_WORKSPACE: WorkspaceDefinition = {
  ...
  sections: [
    {
      ...
      value: "4.2×",
      tone: "up",
      caption: "Blended across 6 channels",
    },
    {
      id: "revenue-growth",
    ...
    { id: "campaigns", title: "Campaigns", value: "6 live", caption: "Best: Winback — 6.1×" },
    {
      ...
      value: "Under-priced 2 tiers",
      caption: "Elasticity study ready",
    },
    ...
    { id: "lead-quality", title: "Lead Quality", value: "72 MQL score", caption: "Up from 68" },
    {
      ...
      value: "84% quota",
      caption: "Top rep at 141%",
    },
    {
      id: "revenue-leakage",
      title: "Revenue Leakage",
      value: "2 streams",
      caption: "$28K MRR at risk",
    },
    ...
    { id: "market-exp", title: "Market Expansion", value: "2 regions ready", caption: "EU + CA" },
    {
      ...
      value: "Strong · Segment 2",
      caption: "3 competitors tracked",
    },
    {
      id: "cltv",
      ...
      delta: "+9%",
      tone: "up",
      caption: "Cohort 2024 leading",
    },
    {
      id: "acq-readiness",
      title: "Acquisition Readiness",
      value: "Green",
      caption: "2 targets pre-qualified",
    },
    {
      id: "opps-engine",
  ...
  timeline: [
    { when: "Mon", label: "New logo closed", detail: "Northwind Bio — $84K ACV", tone: "positive" },
    {
      ...
      detail: "Winback wave 3 — 41 accounts",
      tone: "neutral",
    },
    {
      when: "Wed",
      label: "Churn signal",
      detail: "Cohort 22 — 2 accounts at risk",
      tone: "warning",
    },
    { when: "Thu", label: "Upsell won", detail: "Vertex — +$18K MRR", tone: "positive" },
    {
      when: "Fri",
      label: "Pricing test ready",
      detail: "Tier B elasticity study",
      tone: "neutral",
    },
  ],
  insights: [
    {
      ...
      detail: "A 6% pricing lift + churn hold = +$720K ARR over 12 months.",
    },
    {
      label: "Best channel",
      detail: "Referral partners returned 6.1× ROI — reallocate 15% budget from paid social.",
    },
    {
      label: "Retention driver",
      detail: "Onboarding NPS > 8 correlates with 22% higher 12-month retention.",
    },
  ],
  quickActions: [
...
export const PEOPLE_WORKSPACE: WorkspaceDefinition = {
  ...
  sections: [
    ...
    { id: "education", title: "Education", value: "$6.4K MTD", caption: "3 team members active" },
    {
      ...
      value: "$14.8K left",
      caption: "Underused 34%",
    },
    {
      id: "performance",
      title: "Performance",
      value: "84% on track",
      caption: "Reviews cycle in 21d",
    },
    ...
    { id: "adp", title: "ADP Status", value: "Synced", caption: "Last sync 2 min ago" },
    {
      ...
      value: "3 signals",
      caption: "1 retention, 2 capacity",
    },
  ],
  recommendations: [
    {
  ...
  timeline: [
    {
      ...
      detail: "Sr. Engineer — Team Vertex",
      tone: "positive",
    },
    {
      when: "Tue",
      label: "Commission dispute filed",
      detail: "Q3 attribution — 1 seller",
      tone: "warning",
    },
    ...
    { when: "Thu", label: "Recognition sent", detail: "6 team members — $2.4K", tone: "positive" },
    {
      ...
      detail: "2 members trending overloaded",
      tone: "warning",
    },
  ],
  insights: [
    {
      label: "Retention leverage",
      detail: "Team members receiving quarterly recognition churn 3.4× less.",
    },
    {
      label: "Hiring math",
      detail: "Every week of delay on the two open roles equals $3K in contractor premium.",
    },
    {
      label: "Bonus fairness",
      detail: "Q3 attribution shows 2 outlier splits — recommend review before payout.",
    },
  ],
  quickActions: [
    { label: "Approve Payroll" },
...
export const COMPANY_WORKSPACE: WorkspaceDefinition = {
  ...
  sections: [
    ...
    { id: "investors", title: "Investors", value: "6 on record", caption: "Q3 update sent" },
    {
      ...
      value: "8 active",
      caption: "2 renewals in 60d",
    },
    {
      id: "affiliates",
      title: "Affiliates",
      value: "14 active",
      caption: "Top affiliate 22% of leads",
    },
    ...
    { id: "assets", title: "Assets", value: "$1.42M NBV", caption: "Depreciation on track" },
    {
      ...
      title: "Insurance",
      value: "6 policies",
      caption: "Commercial renews in 22d",
    },
    { id: "entities", title: "Entities", value: "4 active", caption: "US · CA · UK · SG" },
    {
      ...
      title: "Research",
      value: "3 workstreams",
      caption: "Innovation runway 6 mo",
    },
    ...
    { id: "integrations", title: "Integrations", value: "34 live", caption: "All healthy" },
    {
      id: "security",
      title: "Security",
      value: "SOC 2 in progress",
      caption: "82% controls complete",
    },
  ...
  timeline: [
    {
      when: "Q3-01",
      label: "Board packet drafted",
      detail: "12 sections auto-assembled",
      tone: "positive",
    },
    { when: "Q3-02", label: "SOC 2 milestone", detail: "82% controls complete", tone: "positive" },
    {
      when: "Q3-03",
      label: "Vendor overlap flagged",
      detail: "AI portfolio — $6.2K/mo",
      tone: "warning",
    },
    { when: "Q3-04", label: "Insurance quote due", detail: "22 days to expiry", tone: "warning" },
    {
      when: "Q3-05",
      label: "Innovation review",
      detail: "5 bets · 2 near production",
      tone: "neutral",
    },
  ],
  insights: [
    {
      label: "AI cost curve",
      detail: "AI spend growing 18% MoM — outpacing gross margin growth by 11pt.",
    },
    {
      label: "Compliance leverage",
      detail: "Closing SOC 2 unlocks 2 enterprise deals worth $340K ARR.",
    },
    {
      label: "Entity structure",
      detail: "UK sub tax exposure drops 6% with a Q4 elective filing.",
    },
  ],
  quickActions: [
