...
export const APPROVAL_ITEMS: ApprovalItem[] = [
  {
    ...
    approver: "Rose",
    deadline: "Today 5pm",
    supporting: ["Campaign brief", "Q1 ROI = 2.4x"],
    recommendation: "Approve — within ceiling",
  },
  {
    id: "APV-1043",
    source: "bill",
    title: "State filing bulk renewals",
    requestor: "Ops",
    amount: 8400,
    cashImpact: 0,
    marginImpactPct: 0,
    ...
    approver: "Christin",
    deadline: "Tomorrow",
    supporting: ["Pass-through funded"],
    recommendation: "Approve — pass-through covers",
  },
  {
    id: "APV-1044",
    source: "cash_override",
    title: "Override payroll reserve floor",
    requestor: "Rose",
    amount: 22000,
    cashImpact: -22000,
    marginImpactPct: 0,
    ...
    approver: "Dual",
    deadline: "Today 3pm",
    supporting: ["Vendor critical", "5-day extension available"],
    recommendation: "Prefer 5-day delay",
  },
  {
    id: "APV-1045",
    source: "invoice",
    title: "Invoice #2098 — $48k, allocation adjusted",
    requestor: "Sales Ops",
    amount: 48000,
    cashImpact: 32000,
    marginImpactPct: 3.4,
    ...
    approver: "Rose",
    deadline: "Today 6pm",
    supporting: ["Margin above target"],
    recommendation: "Approve & send",
  },
  {
    id: "APV-1046",
    source: "bonus",
    title: "Q1 sales bonus release",
    requestor: "HR",
    amount: 18500,
    cashImpact: -18500,
    marginImpactPct: -0.8,
    ...
    approver: "Rose",
    deadline: "Friday",
    supporting: ["2 invoices unpaid"],
    recommendation: "Release cleared portion only",
  },
  {
    id: "APV-1047",
    source: "subscription",
    title: "Notion Enterprise renewal",
    requestor: "Ops",
    amount: 14400,
    cashImpact: -14400,
    marginImpactPct: -0.3,
    ...
    deadline: "3 days",
    supporting: ["Usage 76%"],
    recommendation: "Renew with seat reduction (−8)",
  },
  {
    id: "APV-1048",
    source: "pre_spend",
    title: "Design agency retainer",
    requestor: "Marketing",
    amount: 9500,
    cashImpact: -9500,
    marginImpactPct: -0.9,
    ...
    approver: "Rose",
    deadline: "Next week",
    supporting: ["No prior spend"],
    recommendation: "Approve 60-day pilot",
  },
  {
    id: "APV-1049",
    source: "reconciliation",
    title: "Chase Op ×4421 — $84 variance",
    requestor: "System",
    amount: 84,
    cashImpact: 0,
    marginImpactPct: 0,
    ...
    approver: "Christin",
    deadline: "This week",
    supporting: ["Timing difference"],
    recommendation: "Approve reconciliation",
  },
  {
    id: "APV-1050",
    source: "leakage_recovery",
    title: "Recover unbilled reimbursables — Acme",
    requestor: "Sales Ops",
    amount: 3200,
    cashImpact: 3200,
    marginImpactPct: 0.4,
    risk: "low",
    approver: "Rose",
    deadline: "Next invoice",
    supporting: ["4 expenses attached"],
    recommendation: "Add to next invoice",
  },
  {
    id: "APV-1051",
    source: "budget_exception",
    title: "Dev tools — over budget 12%",
...
export const EXCEPTIONS: ExceptionItem[] = [
  {
    ...
    title: "Payment applied without pass-through split",
    detail: "Payment #P-5541 · $18,400 · missing state fee line",
    dollarImpact: 18400,
    age: 2,
    urgency: "high",
    compliance: true,
  ...
  },
  {
    id: "EX-2002",
    type: "unmatched",
    title: "Wire deposit unmatched",
    detail: "Chase Op ×4421 · $32,600 · no invoice match",
    dollarImpact: 32600,
    age: 4,
    urgency: "high",
    compliance: false,
  ...
  },
  {
    ...
    title: "Missing receipt over $500",
    detail: "Rose · Delta · $612",
    dollarImpact: 612,
    age: 3,
    urgency: "medium",
    compliance: true,
  ...
  },
  {
    id: "EX-2004",
    type: "policy",
    title: "Non-reimbursable submitted",
    detail: "Client entertainment · $340",
    dollarImpact: 340,
    age: 1,
    urgency: "low",
    compliance: true,
  ...
  },
  {
    id: "EX-2005",
    type: "integration",
    title: "Stripe webhook failed 3×",
    detail: "Retry queue backed up · last 6 hr",
    dollarImpact: 0,
    age: 0,
    urgency: "high",
    compliance: false,
  ...
  },
  {
    id: "EX-2006",
    type: "attribution",
    title: "Revenue with no service",
    detail: "$4,200 · client unknown",
    dollarImpact: 4200,
    age: 6,
    urgency: "medium",
    compliance: false,
  ...
  },
  {
    id: "EX-2007",
    type: "leakage",
    title: "Unbilled reimbursable > 14d",
    detail: "Acme · 4 expenses · $3,200",
    dollarImpact: 3200,
    age: 15,
    urgency: "medium",
    compliance: false,
  ...
  },
  {
    id: "EX-2008",
    type: "bonus_verify",
    title: "Bonus math off by $88",
    detail: "Q1 payout · rounding",
    dollarImpact: 88,
    age: 2,
    urgency: "low",
    compliance: true,
  ...
  },
  {
    id: "EX-2009",
    type: "reconciliation",
    title: "Bank feed variance",
    detail: "Op ×4421 · $84 timing",
    dollarImpact: 84,
    age: 5,
    urgency: "low",
    compliance: false,
  ...
  },
  {
    id: "EX-2010",
    type: "forecast_risk",
    title: "Projected cash < guardrail in 21d",
    detail: "Confidence 82% · 2 large bills due",
    dollarImpact: 42000,
    age: 0,
    urgency: "high",
    compliance: false,
  ...
  },
  {
    id: "EX-2011",
    type: "data_quality",
    title: "6 vendors missing GL mapping",
    detail: "New vendors from Q1 import",
    dollarImpact: 0,
    age: 9,
    urgency: "medium",
    compliance: true,
  ...
  },
  {
    id: "EX-2012",
    type: "accounting",
    title: "Journal draft awaiting review",
    detail: "Depreciation catch-up · $2,850",
    dollarImpact: 2850,
    age: 3,
    urgency: "medium",
    compliance: true,
...
export const COLLECTIONS: CollectionItem[] = [
  {
    ...
    daysOverdue: 12,
    probability: 78,
    paymentBehavior: "late_20",
    lastReminder: "3 days ago",
    remindersSent: 2,
    promiseDate: "Fri",
    dispute: false,
    serviceHold: false,
    recommendedContact: "Call CFO · Wed 2pm",
    expectedCollection: "Next 7 days",
    escalation: "Manager review at 21d",
  },
  {
    id: "C-2",
    invoice: "INV-2088",
    client: "Blue Ridge Legal",
    amount: 8800,
    daysOverdue: 6,
    probability: 92,
    ...
    dispute: false,
    serviceHold: false,
    recommendedContact: "Friendly reminder · email",
    expectedCollection: "This week",
    escalation: "None yet",
  },
  {
    id: "C-3",
    ...
    daysOverdue: 34,
    probability: 41,
    paymentBehavior: "erratic",
    lastReminder: "7 days ago",
    remindersSent: 4,
    dispute: true,
    serviceHold: true,
    recommendedContact: "Escalate to Rose",
    expectedCollection: "Uncertain",
    escalation: "Legal notice ready",
  },
  {
    id: "C-4",
    invoice: "INV-2081",
    client: "Pacific Retail",
    amount: 15600,
    daysOverdue: 19,
    probability: 66,
    paymentBehavior: "late_40",
    lastReminder: "4 days ago",
    remindersSent: 3,
    promiseDate: "Mon",
    dispute: false,
    serviceHold: false,
    recommendedContact: "Confirm promise · Mon 10am",
    expectedCollection: "Next 14 days",
    escalation: "Service hold at 30d",
  },
  {
    id: "C-5",
    invoice: "INV-2065",
    client: "Riverdale Estates",
    amount: 6200,
    daysOverdue: 45,
    probability: 28,
    paymentBehavior: "erratic",
    lastReminder: "12 days ago",
    remindersSent: 5,
    dispute: false,
    serviceHold: true,
    recommendedContact: "Final notice",
    expectedCollection: "Doubtful",
    escalation: "Send to collections",
  },
];
...
export const PAYABLES: PayableItem[] = [
  ...
  {
    id: "P-2",
    vendor: "State of NY (client filing)",
    bill: "BILL-8802",
    amount: 6200,
    due: "Feb 24",
    priority: "restricted",
  ...
  {
    id: "P-4",
    vendor: "Contract counsel",
    bill: "BILL-8804",
    amount: 14500,
    due: "Feb 20",
    priority: "critical_delivery",
    cashImpact: -14500,
...
export const GUARDRAILS: Guardrail[] = [
  {
    ...
    target: 140000,
    status: "healthy",
    description: "≥ 2 payroll cycles reserved",
  },
  {
    id: "g2",
    label: "Tax Reserve",
    ...
    target: 60000,
    status: "healthy",
    description: "Q1 estimated + safety",
  },
  {
    id: "g3",
    label: "Pass-through Reserve",
    current: 41200,
    target: 41200,
    status: "healthy",
    description: "Matches outstanding obligations",
  },
  {
    id: "g4",
    ...
    target: 24000,
    status: "watch",
    description: "Slight shortfall for Q1",
  },
  {
    id: "g5",
    ...
    target: 90000,
    status: "healthy",
    description: "Rolling 30-day minimum",
  },
  {
    id: "g6",
    label: "Max Discretionary / mo",
    current: 18600,
    target: 20000,
    status: "healthy",
    description: "Cap on non-essential spend",
  },
  {
    id: "g7",
    label: "Max Marketing / mo",
    current: 21800,
    target: 20000,
    status: "breach",
    description: "Over ceiling by $1.8k",
  },
  {
    id: "g8",
    label: "Tech Spend Ceiling / mo",
    current: 12400,
    target: 15000,
    status: "healthy",
  ...
  },
  {
    ...
    target: 2500,
    status: "healthy",
    description: "Any expense ≥ $2.5k → Rose",
  },
];
...
export const OVERRIDES: Override[] = [
  {
    id: "OV-1",
    guardrail: "Max Marketing / mo",
    reason: "Product launch buy",
    approver: "Rose",
    expires: "Feb 28",
    impact: "+$1.8k over cap",
    auditId: "AUD-4491",
  },
  {
    id: "OV-2",
    guardrail: "Payroll Reserve",
    reason: "One-time vendor deposit",
    approver: "Dual",
    expires: "Feb 24",
    impact: "−$8k, restores Fri",
    auditId: "AUD-4498",
  },
];
...
export const SUB_ACTIONS: SubAction[] = [
  ...
  },
  {
    ...
    status: "in_progress",
    due: "Mar 10",
    notes: "Enterprise ramp discount",
  },
  {
    id: "SA-3",
    vendor: "Zapier",
    ...
    realizedSavings: 1800,
    status: "done",
    due: "—",
    notes: "Replaced by n8n",
  },
  {
    id: "SA-4",
    vendor: "Loom",
    ...
    status: "open",
    due: "Mar 05",
    notes: "Fold into Google Workspace",
  },
  {
    id: "SA-5",
    vendor: "Superhuman",
    recommendation: "usage_review",
    owner: "Sales",
    expectedSavings: 1400,
    realizedSavings: 0,
    status: "open",
    due: "Feb 28",
    notes: "Low usage 3 seats",
  },
  {
    id: "SA-6",
    vendor: "Various AI tools",
    ...
    status: "in_progress",
    due: "Mar 15",
    notes: "Consolidate on 2 vendors",
  },
];
...
export const RECOVERIES: RecoveryItem[] = [
  {
    id: "REC-1",
    client: "Acme Holdings",
    source: "Unbilled reimbursables (4)",
    amount: 3200,
    confidence: 94,
    status: "on_next_invoice",
    owner: "Sales Ops",
    action: "Bundle into INV-2101",
    collected: 0,
  },
  {
    id: "REC-2",
    client: "Blue Ridge Legal",
    source: "Overage on retainer",
    amount: 1450,
    confidence: 88,
    status: "verified",
    owner: "Rose",
  ...
  },
  {
    id: "REC-4",
    client: "Northgate Ventures",
    source: "Duplicate refund reversal",
    amount: 620,
    confidence: 100,
    status: "collected",
    owner: "Christin",
  ...
  {
    id: "REC-6",
    client: "Old Legacy Co",
    source: "Aged unbilled",
    amount: 900,
    confidence: 34,
...
export const DATA_QUALITY: DataQualityIssue[] = [
  {
    id: "DQ-1",
    category: "Missing GL mapping",
    count: 6,
    impact: "medium",
    example: "6 new vendors this quarter",
    owner: "Christin",
  },
  {
    id: "DQ-2",
    category: "Missing client assignment",
    count: 12,
    impact: "high",
    example: "$8.4k of expenses unassigned",
    owner: "Sales Ops",
  },
  {
    id: "DQ-3",
    category: "Missing project attribution",
    count: 22,
    impact: "medium",
    example: "Design work unattributed",
    owner: "PMs",
  },
  {
    id: "DQ-4",
    category: "Missing receipts",
    count: 8,
    impact: "medium",
    example: "$2.1k over threshold",
    owner: "Rose",
  },
  {
    id: "DQ-5",
    category: "Duplicate vendors",
    count: 4,
    impact: "low",
  ...
  {
    id: "DQ-6",
    category: "Invalid account mapping",
    count: 2,
    impact: "high",
    example: "Cash routed to income account",
    owner: "Christin",
  },
  {
    id: "DQ-7",
    category: "Unassigned subscription owner",
    count: 9,
    impact: "low",
    example: "9 tools ownerless",
    owner: "Ops",
  },
  {
    id: "DQ-8",
    category: "Stale customer records",
    count: 14,
    impact: "low",
    example: "Not updated in 12+ months",
    owner: "Sales Ops",
  },
  {
    id: "DQ-9",
    category: "Unverified bonus records",
    count: 3,
    impact: "medium",
    example: "Q1 payouts pending audit",
    owner: "HR",
  },
  {
    id: "DQ-10",
    category: "Unreconciled accounts",
    count: 1,
    impact: "high",
    example: "Chase Op ×4421",
    owner: "Christin",
  },
  {
    id: "DQ-11",
    category: "Failed source-system mappings",
    count: 5,
    impact: "medium",
    example: "Stripe → GL",
    owner: "Engineering",
...
export const DECISION_LOG: DecisionEntry[] = [
  {
    ...
    date: "2026-02-18",
    type: "approved_spend",
    title: "Approve Meta Q1 launch buy",
    decidedBy: "Rose",
    amount: 12500,
    rationale: "Q1 ROI target 2.4x; within launch window",
    linkedRecords: ["APV-1042"],
  },
  {
    id: "D-02",
    date: "2026-02-17",
    type: "software_cancel",
    title: "Cancel Zapier",
    decidedBy: "Christin",
    amount: -1800,
    rationale: "Replaced by n8n; usage < 5%",
    linkedRecords: ["SA-3"],
  },
  {
    id: "D-03",
    date: "2026-02-15",
    type: "bonus",
    title: "Hold Kai M. Q1 bonus",
    decidedBy: "Rose",
    amount: -5400,
    rationale: "INV-2072 disputed; release after collection",
    linkedRecords: ["BC-4"],
  },
  {
    id: "D-04",
    date: "2026-02-14",
    type: "vendor_reneg",
    title: "Figma enterprise ramp discount",
    decidedBy: "Rose",
    amount: -3200,
    rationale: "Renewal negotiation window",
    linkedRecords: ["SA-2"],
  },
  {
    id: "D-05",
    ...
    title: "Marketing ceiling override",
    decidedBy: "Dual",
    amount: 1800,
    rationale: "One-time launch buy, expires Feb 28",
    linkedRecords: ["OV-1"],
  },
  {
    id: "D-06",
    date: "2026-02-10",
    type: "rejected_spend",
    title: "Reject 3rd design agency retainer",
    decidedBy: "Rose",
    amount: -9500,
    rationale: "Insufficient ROI evidence; revisit Q2",
    linkedRecords: ["APV-1048"],
  },
  {
    id: "D-07",
    date: "2026-02-08",
    type: "pricing",
    title: "Raise retainer floor to $6k/mo",
    decidedBy: "Rose",
    amount: 0,
    rationale: "Below-target margin on <$6k retainers",
    linkedRecords: ["Profitability report"],
  },
  {
    id: "D-08",
    date: "2026-02-05",
    type: "reserve_change",
    title: "Raise payroll reserve target",
    decidedBy: "Rose",
    amount: 20000,
    rationale: "Team growth + longer AR cycle",
    linkedRecords: ["Guardrails"],
  },
  {
    id: "D-09",
    date: "2026-02-03",
    type: "campaign_increase",
    title: "Google branded +$3k / mo",
    decidedBy: "Rose",
    amount: 3000,
    rationale: "42-day payback, above threshold",
    linkedRecords: ["Marketing ROI"],
  },
  {
    id: "D-10",
    date: "2026-02-01",
    type: "client_exception",
    title: "Waive late fee — Acme",
    decidedBy: "Rose",
    amount: -320,
    rationale: "Long-standing client goodwill",
    linkedRecords: ["INV-2088"],
  },
];
