...
export const HEALTH_SUMMARY = [
  ...
  {
    label: "Revenue leakage opportunities",
    status: "watch" as const,
    detail: "$42.2k recoverable",
  },
];
...
export type OverheadStatus =
  "healthy" | "watch" | "above_budget" | "material_increase" | "under_review" | "structural_risk";
...
export const OVERHEAD_CATEGORIES = [
  {
    ...
    ytd: 462_800,
    owner: "Christin",
    status: "healthy" as OverheadStatus,
    anomalies: 0,
  },
  {
    key: "contractor",
    ...
    ytd: 62_400,
    owner: "Rose",
    status: "above_budget" as OverheadStatus,
    anomalies: 1,
  },
  {
    key: "software",
    ...
    ytd: 110_800,
    owner: "Carmen",
    status: "watch" as OverheadStatus,
    anomalies: 2,
  },
  {
    key: "ai",
    ...
    ytd: 46_100,
    owner: "Rose",
    status: "material_increase" as OverheadStatus,
    anomalies: 1,
  },
  {
    key: "marketing",
...
export const OVERHEAD_ANOMALIES: OverheadAnomaly[] = [
  {
    ...
    suggestedAction:
      "Review Copilot workloads for unnecessary retries; consider prompt-caching tier.",
    status: "open",
  },
  {
    id: "OA-002",
  ...
  },
  {
    ...
    suggestedAction:
      "Rebalance: consolidate to one primary vendor; enforce owner sign-off on new AI SaaS.",
    status: "open",
  },
  {
    id: "OA-006",
...
export const TECH_PORTFOLIO = [
  {
    ...
    activeUsers: 11,
    utilization: 0.92,
    costPerActiveUser: 347,
    renewal: "2026-04-01",
    cancelBy: "2026-03-15",
    revenueSupported: 380_000,
    laborSaved: 210,
    importance: 5,
    recommendation: "Keep; monitor cost per completion",
    status: "core" as TechStatus,
  },
  {
    id: "T-002",
    vendor: "Replit",
    ...
    activeUsers: 4,
    utilization: 0.8,
    costPerActiveUser: 55,
    renewal: "2026-02-01",
    cancelBy: "2026-01-15",
    revenueSupported: 62_000,
    laborSaved: 44,
    importance: 4,
    recommendation: "Keep",
    status: "healthy" as TechStatus,
  },
  {
    id: "T-003",
    vendor: "Lovable",
    ...
    activeUsers: 5,
    utilization: 0.83,
    costPerActiveUser: 80,
    renewal: "2026-05-01",
    cancelBy: "2026-04-15",
    revenueSupported: 120_000,
    laborSaved: 62,
    importance: 5,
    recommendation: "Core — expanding usage",
    status: "high_strategic_value" as TechStatus,
  },
  {
    id: "T-004",
    vendor: "Zoho",
    ...
    activeUsers: 20,
    utilization: 0.91,
    costPerActiveUser: 44.5,
    renewal: "2026-01-15",
    cancelBy: "2026-01-01",
    revenueSupported: 640_000,
    laborSaved: 180,
    importance: 5,
    recommendation: "Renew; annual saves 20%",
    status: "renewal_soon" as TechStatus,
  },
  {
    id: "T-005",
    vendor: "Vercel",
    ...
    activeUsers: 4,
    utilization: 1.0,
    costPerActiveUser: 60,
    renewal: "2026-06-01",
    cancelBy: "2026-05-15",
    revenueSupported: 96_000,
    laborSaved: 18,
    importance: 4,
    recommendation: "Keep",
    status: "healthy" as TechStatus,
  },
  {
    ...
    activeUsers: 7,
    utilization: 0.88,
    costPerActiveUser: 45.7,
    renewal: "2026-09-01",
    cancelBy: "2026-08-15",
    revenueSupported: 220_000,
    laborSaved: 92,
    importance: 5,
    recommendation: "Keep",
    status: "core" as TechStatus,
  },
  {
    ...
    activeUsers: 3,
    utilization: 0.6,
    costPerActiveUser: 49.7,
    renewal: "2026-03-01",
    cancelBy: "2026-02-15",
    revenueSupported: 32_000,
    laborSaved: 22,
    importance: 3,
    recommendation: "Consolidate with workspace B",
    status: "duplicate" as TechStatus,
  },
  {
    id: "T-008",
    vendor: "Canva",
    product: "Pro (workspace B)",
    category: "Design",
    owner: "-",
    department: "Marketing",
    monthly: 149,
    ...
    activeUsers: 1,
    utilization: 0.2,
    costPerActiveUser: 149,
    renewal: "2026-03-01",
    cancelBy: "2026-02-15",
    revenueSupported: 12_000,
    laborSaved: 4,
    importance: 2,
    recommendation: "Cancel",
    status: "cancellation_candidate" as TechStatus,
  },
  {
    id: "T-009",
    vendor: "RingCentral",
    ...
    renewal: "2026-07-01",
    cancelBy: "2026-06-15",
    revenueSupported: 180_000,
    laborSaved: 42,
    importance: 4,
    recommendation: "Reduce 2 seats",
    status: "underused" as TechStatus,
  },
  {
    id: "T-010",
    vendor: "ADP",
  ...
  },
  {
    ...
    activeUsers: 8,
    utilization: 1.0,
    costPerActiveUser: 3.1,
    renewal: "2026-12-01",
    cancelBy: "2026-11-15",
    revenueSupported: 140_000,
    laborSaved: 36,
    importance: 5,
    recommendation: "Keep",
    status: "high_strategic_value" as TechStatus,
  },
  {
    id: "T-012",
    vendor: "Google",
    product: "Workspace Business Plus",
  ...
  },
  {
    ...
    activeUsers: 2,
    utilization: 0.25,
    costPerActiveUser: 160,
    renewal: "2026-08-01",
    cancelBy: "2026-07-15",
    revenueSupported: 8_000,
    laborSaved: 4,
    importance: 2,
    recommendation: "Reduce to 3 seats",
    status: "underused" as TechStatus,
  },
];
...
export const APPS = [
  {
    ...
    roi: 0,
    score: 78,
    status: "strategic_investment" as AppStatus,
  },
  {
    id: "APP-002",
    name: "Command Center",
    ...
    roi: 3.8,
    score: 86,
    status: "profitable" as AppStatus,
  },
  {
    id: "APP-003",
    ...
    activeUsers: 220,
    clients: 180,
    directRevenue: 420_000,
    revenueInfluenced: 180_000,
    timeSaved: 480,
    errorsPrevented: 62,
    riskReduced: "High",
    payback: 6,
  ...
  },
  {
    ...
    activeUsers: 48,
    clients: 44,
    directRevenue: 180_000,
    revenueInfluenced: 62_000,
    timeSaved: 210,
    errorsPrevented: 18,
    riskReduced: "High",
    payback: 8,
  ...
  },
  {
    ...
    activeUsers: 180,
    clients: 160,
    directRevenue: 320_000,
    revenueInfluenced: 140_000,
    timeSaved: 380,
    errorsPrevented: 54,
  ...
  },
  {
    ...
    activeUsers: 12,
    clients: 8,
    directRevenue: 48_000,
    revenueInfluenced: 22_000,
    timeSaved: 88,
    errorsPrevented: 6,
    riskReduced: "Medium",
    payback: 12,
    roi: 2.1,
    score: 71,
    status: "approaching_payback" as AppStatus,
  },
  {
    id: "APP-007",
    ...
    roi: 0.6,
    score: 42,
    status: "needs_adoption" as AppStatus,
  },
  {
    id: "APP-008",
    name: "TrustScore",
    ...
    activeUsers: 38,
    clients: 30,
    directRevenue: 96_000,
    revenueInfluenced: 42_000,
    timeSaved: 120,
    errorsPrevented: 14,
    riskReduced: "High",
    payback: 9,
  ...
  },
  {
    ...
    roi: 0.3,
    score: 34,
    status: "sunset_candidate" as AppStatus,
  },
  {
    id: "APP-010",
    name: "Sales Intelligence OS",
    devCost: 58_000,
    monthly: 420,
    hosting: 100,
    aiUsage: 240,
...
export const CAMPAIGNS = [
  ...
  {
    id: "C-103",
    name: "LinkedIn — Enterprise Compliance",
    channel: "Social",
    platform: "LinkedIn",
    owner: "Rose",
    start: "2025-04-02",
  ...
  {
    id: "C-104",
    name: "Email Nurture — Renewals",
    channel: "Email",
    platform: "Zoho Marketing",
    owner: "Christin",
    start: "2025-01-15",
    status: "active" as CampaignStatus,
    spend: 2_100,
...
export const MARKETING_ALERTS = [
  {
    severity: "high",
    vendor: "YouTube Pre-roll — Brand",
    detail: "Spend $8.8k, 1 deal, negative contribution",
    action: "Pause and reallocate",
  },
  {
    severity: "medium",
    vendor: "Meta Retargeting — SMB",
    detail: "CPA $1,067 — above $850 target",
    action: "Refresh creative; tighten audience",
  },
  {
    severity: "low",
    vendor: "LinkedIn — Enterprise Compliance",
    detail: "Payback 28 days, best ROI — consider budget lift",
...
export const BONUSES = [
  {
    ...
    employee: "A. Rivera",
    department: "Sales",
    plan: "Sales commission tier 2",
    period: "Aug 2026",
    trigger: "Collected revenue > $60k",
    projected: 6_200,
    earned: 4_800,
    approved: 4_800,
    payable: 4_800,
    paid: 0,
    holdback: 480,
    status: "approved" as BonusStatus,
    approver: "Rose",
  },
  {
    id: "B-002",
    employee: "J. Nguyen",
    department: "Sales",
    plan: "Sales commission tier 1",
    period: "Aug 2026",
    trigger: "Collected revenue > $30k",
    projected: 3_400,
    earned: 2_100,
    approved: 0,
    payable: 0,
    paid: 0,
    holdback: 210,
    status: "pending_rose" as BonusStatus,
    approver: "Rose",
  },
  {
    id: "B-003",
    ...
    plan: "Turnaround-time bonus",
    period: "Q3 2026",
    trigger: "Avg turnaround < 4 days",
    projected: 1_800,
    earned: 1_800,
    approved: 1_800,
    payable: 1_800,
  ...
  },
  {
    ...
    paid: 0,
    holdback: 0,
    status: "pending_verification" as BonusStatus,
    approver: "Christin",
  },
  {
    id: "B-005",
    employee: "S. Alvarez",
    department: "Fulfillment",
    plan: "Fulfillment milestone",
    period: "Aug 2026",
    trigger: "50 filings completed",
    projected: 2_400,
    earned: 2_400,
    approved: 2_400,
    payable: 2_400,
  ...
  },
  {
    ...
    employee: "K. Rose",
    department: "Marketing",
    plan: "Campaign performance",
    period: "Aug 2026",
    trigger: "Profit ROI > 2.0",
    projected: 3_800,
    earned: 2_100,
    approved: 0,
    payable: 0,
    paid: 0,
    holdback: 0,
    status: "tracking" as BonusStatus,
    approver: "Rose",
  },
  {
    id: "B-007",
    ...
    paid: 0,
    holdback: 280,
    status: "scheduled" as BonusStatus,
    approver: "Rose",
  },
  {
    id: "B-008",
    employee: "D. Kim",
    department: "Sales",
    plan: "Sales commission tier 3",
    period: "Jul 2026",
    trigger: "Collected revenue > $100k",
    projected: 8_200,
    earned: 8_200,
    approved: 8_200,
    payable: 8_200,
  ...
  },
  {
    ...
    paid: 1_600,
    holdback: 0,
    status: "clawback" as BonusStatus,
    approver: "Rose",
  },
];
...
export const BONUS_PLANS = [
  {
    ...
    calc: "Tiered % 6-8-10",
    max: 12_000,
    holdback: "10% for 60 days",
    approver: "Rose",
    effective: "2025-01-01",
  },
  {
    id: "BP-002",
    name: "Turnaround-time bonus",
    type: "Turnaround-time bonus",
    eligible: 8,
    department: "Fulfillment",
  ...
  },
  {
    ...
    type: "Expansion revenue",
    eligible: 6,
    department: "Sales",
    metric: "Upsell revenue",
    trigger: "> $10k per deal",
    calc: "10%",
    max: 8_000,
    holdback: "10%",
    approver: "Rose",
...
export const CLIENT_PROFITABILITY = [
  {
    ...
    payment: "On time",
    burden: "Low",
    status: "highly_profitable" as ProfitStatus,
  },
  {
    id: "CL-002",
    ...
    payment: "On time",
    burden: "Medium",
    status: "healthy" as ProfitStatus,
  },
  {
    id: "CL-003",
    client: "Pinehurst Holdings",
    revenue: 62_800,
    passthrough: 9_200,
    commission: 4_100,
    labor: 22_400,
    ...
    payment: "Slow",
    burden: "High",
    status: "below_target" as ProfitStatus,
  },
  {
    id: "CL-004",
    client: "Cypress Retail Co",
    revenue: 42_400,
    passthrough: 6_400,
    commission: 2_800,
    labor: 18_200,
    ...
    payment: "Slow",
    burden: "High",
    status: "at_risk" as ProfitStatus,
  },
  {
    id: "CL-005",
    client: "Silverstone Group",
    revenue: 128_600,
    passthrough: 24_800,
    commission: 8_400,
    labor: 28_400,
  ...
  },
  {
    ...
    payment: "Very slow",
    burden: "Very high",
    status: "unprofitable" as ProfitStatus,
  },
  {
    id: "CL-007",
  ...
  },
  {
    ...
    payment: "On time",
    burden: "High",
    status: "pricing_review" as ProfitStatus,
  },
];
...
export const SERVICE_PROFITABILITY = [
  ...
  {
    id: "SVC-002",
    name: "Expansion Readiness Roadmap",
    avgPrice: 6_800,
    passthrough: 400,
    commission: 680,
    labor: 2_400,
  ...
  {
    id: "SVC-004",
    name: "Qualifier Review and Placement",
    avgPrice: 2_400,
    passthrough: 800,
    commission: 240,
    labor: 900,
...
export const DEPARTMENT_PROFITABILITY = [
  {
    name: "Sales",
    revenueSupported: 1_248_750,
    directRevenue: 1_248_750,
    directCost: 128_400,
    overhead: 62_400,
    payroll: 168_400,
    tech: 12_400,
    bonus: 22_400,
    contribution: 288_800,
    efficiency: 2.28,
...
export const ATTRIBUTION_EXPENSES = [
  {
    ...
    vendor: "OpenAI",
    amount: 3_820,
    method: "usage" as AllocationMethod,
    allocated: 100,
    targets: [
      { label: "LedgerOS", pct: 22 },
      { label: "Command Center", pct: 18 },
      { label: "ComplianceConnect", pct: 34 },
      { label: "Shared overhead", pct: 26 },
    ],
    unallocated: 0,
    marginImpact: -2.1,
    confidence: 88,
    evidence: "Vendor API usage export · 2,140 calls",
  },
  {
    id: "EX-A-002",
    vendor: "AWS Hosting",
    ...
    allocated: 100,
    targets: [
      { label: "Business Services Hub", pct: 42 },
      { label: "LedgerOS", pct: 22 },
      { label: "Facility Intelligence", pct: 12 },
      { label: "Shared", pct: 24 },
    ],
    unallocated: 0,
    marginImpact: -0.4,
    confidence: 92,
    evidence: "AWS cost explorer tag map",
  },
  {
    id: "EX-A-003",
    vendor: "Zoho One",
    ...
    targets: [
      { label: "Sales", pct: 40 },
      { label: "Fulfillment", pct: 30 },
      { label: "Admin", pct: 30 },
    ],
    unallocated: 0,
    marginImpact: -0.6,
    confidence: 95,
    evidence: "Active seat report",
  },
  {
    id: "EX-A-004",
    vendor: "LinkedIn Ads",
    ...
    allocated: 100,
    targets: [{ label: "C-103 Enterprise Compliance", pct: 100 }],
    unallocated: 0,
    marginImpact: -12.2,
    confidence: 100,
    evidence: "Ad account invoice",
  },
  {
    id: "EX-A-005",
    vendor: "Alacer Advisory",
    amount: 1_200,
    method: "manual" as AllocationMethod,
    allocated: 40,
    targets: [{ label: "R&D", pct: 40 }],
    unallocated: 720,
    marginImpact: -0.8,
    confidence: 42,
    evidence: "No contract on file",
  },
  {
    id: "EX-A-006",
    vendor: "Canva (both)",
...
export const CONFIDENCE_COMPONENTS = [
  {
    ...
    current: 11,
    max: 12,
    gap: "1 unreconciled bank account",
    impact: 1,
  },
  {
    key: "uncategorized",
  ...
  },
  {
    ...
    current: 6,
    max: 8,
    gap: "8 anomalies open",
    impact: 2,
  },
  {
    key: "attribution",
    label: "Incomplete expense allocation",
    weight: 8,
    current: 7,
    max: 8,
    gap: "$720 unallocated",
...
export type LeakageStatus =
  "new" | "verified" | "invoice_draft" | "invoiced" | "collected" | "dismissed" | "not_recoverable";
...
export const LEAKAGE_OPPS: LeakageOpportunity[] = [
  {
    id: "L-001",
    client: "ALD Facility Services",
    service: "Foreign Registration filing",
    source: "ComplianceConnect",
    amount: 620,
    confidence: 96,
    ageDays: 12,
    reason: "Pass-through fee paid but not billed",
    evidence: "State filing receipt 8/12 — no client invoice line",
    action: "Draft supplemental invoice",
    owner: "Christin",
    status: "new",
  },
  {
    id: "L-002",
    client: "Pinehurst Holdings",
    service: "Renewal — Registered Agent",
    source: "Zoho CRM",
    amount: 320,
    confidence: 98,
    ageDays: 22,
    reason: "Renewal not invoiced",
    evidence: "Renewal due 7/22 · no invoice",
  ...
  },
  {
    id: "L-003",
    client: "Cypress Retail Co",
    service: "Business License add-on",
    source: "Business Services Hub",
    amount: 480,
    confidence: 88,
    ageDays: 8,
    reason: "Add-on delivered without charge",
    evidence: "Service ticket #4218 closed 8/4",
  ...
  },
  {
    ...
    confidence: 92,
    ageDays: 34,
    reason: "Recurring invoice missing",
    evidence: "Aug schedule did not fire",
    action: "Backfill invoice",
    owner: "Christin",
    status: "new",
  },
  {
    ...
    confidence: 76,
    ageDays: 16,
    reason: "Client receiving service beyond package",
    evidence: "58 hours logged · 40 in scope",
    action: "Prepare overage invoice",
    owner: "Rose",
    status: "verified",
  },
  {
    id: "L-006",
    client: "Northgate Ventures",
    service: "Compliance Risk Audit",
    source: "Manual",
    amount: 4_500,
    confidence: 82,
    ageDays: 5,
    reason: "Completed service not invoiced",
    evidence: "Audit delivered 8/8",
    action: "Create invoice",
    owner: "Rose",
  ...
  },
  {
    id: "L-007",
    client: "Cypress Retail Co",
    service: "State examination fee",
    source: "Bank feed",
    amount: 340,
    confidence: 94,
    ageDays: 44,
    reason: "Client expense not recovered",
    evidence: "Card charge · matched to client project",
    action: "Recover on next invoice",
    owner: "Christin",
    status: "verified",
  },
  {
    id: "L-008",
    client: "Meridian Group",
    service: "Missing late fee",
    source: "Zoho Books",
    amount: 180,
    confidence: 100,
    ageDays: 46,
    reason: "Missing late fee",
    evidence: "Invoice INV-2178 paid 46 days late",
    action: "Apply 5% late fee",
    owner: "Christin",
    status: "new",
  },
  {
    ...
    confidence: 89,
    ageDays: 3,
    reason: "Failed recurring payment",
    evidence: "Card declined 8/9",
    action: "Notify client; retry",
    owner: "Christin",
    status: "new",
  },
  {
    id: "L-010",
    client: "Northgate Ventures",
    service: "Qualifier fee",
    source: "QualifierConnect",
    amount: 620,
    confidence: 94,
    ageDays: 18,
    reason: "Uncollected qualifier fee",
    evidence: "Placement completed · fee not on invoice",
    action: "Add to next invoice",
    owner: "Rose",
    status: "verified",
  },
  {
    id: "L-011",
    client: "Sales team",
    service: "Commission overpayment",
    source: "Payroll",
    amount: 480,
    confidence: 84,
    ageDays: 12,
    reason: "Commission overpayment",
    evidence: "Chargeback occurred · commission not adjusted",
    action: "Clawback next payroll",
    owner: "Christin",
    status: "verified",
  },
  {
    ...
    confidence: 78,
    ageDays: 22,
    reason: "Unbilled change order",
    evidence: "Scope note 7/22 · no CO issued",
    action: "Issue change order",
    owner: "Rose",
    status: "new",
  },
];
...
export const RECOMMENDATIONS: Recommendation[] = [
  {
    id: "R-001",
    category: "cancel_software",
    title: "Cancel duplicate Canva workspace",
    evidence:
      "Two Canva Pro workspaces with overlapping teams; workspace B has 1 active user of 5 seats.",
    impact: 1_788,
    horizon: "30 days",
    confidence: 96,
    risks: "Minor — verify no external shares.",
    owner: "Rose",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-002",
    category: "reduce_seats",
    title: "Reduce Notion to 3 seats",
    evidence: "8 seats provisioned; 2 with logins in last 45 days.",
    impact: 2_400,
    horizon: "60 days",
    confidence: 91,
    risks: "Downgrade requires plan change.",
    owner: "Carmen",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-003",
    category: "increase_budget",
    title: "Increase LinkedIn Enterprise Compliance +25%",
    evidence: "Profit ROI 3.86 · payback 28 days · lowest chargeback.",
    impact: 12_400,
    horizon: "30 days",
    confidence: 88,
    risks: "Diminishing returns above +30%.",
    owner: "Rose",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-004",
    category: "pause_campaign",
    title: "Pause YouTube pre-roll",
    evidence: "Spend $8.8k · 1 deal · contribution -$1.8k.",
    impact: 8_800,
    horizon: "Immediate",
    confidence: 94,
    risks: "Loss of brand impressions.",
    owner: "Rose",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-005",
    category: "recover_revenue",
    title: "Recover $42.2k in leakage opportunities",
    evidence: "12 verified opportunities across 8 clients.",
    impact: 42_180,
    horizon: "60 days",
    confidence: 84,
    risks: "Client relationship on 2 items.",
    owner: "Christin",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-006",
    category: "reprice_service",
    title: "Reprice Business License service",
    evidence: "Contribution margin 11.7% vs 25% target; rework 3.8%.",
    impact: 18_400,
    horizon: "90 days",
    confidence: 78,
    risks: "May lose 5-8% of low-margin volume.",
    owner: "Rose",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-007",
    category: "review_client_scope",
    title: "Review Blue Harbor Partners scope",
    evidence: "Contribution -$1.8k · very slow pay · very high service burden.",
    impact: 1_800,
    horizon: "30 days",
    confidence: 82,
    risks: "Client offboarding risk.",
    owner: "Rose",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-008",
    category: "consolidate_tools",
    title: "Consolidate AI vendor concentration",
    evidence: "OpenAI = 38% of AI spend and 62% of automation dependencies.",
    impact: 0,
    horizon: "180 days",
    confidence: 74,
  ...
  {
    id: "R-009",
    category: "adjust_bonus_reserve",
    title: "Increase bonus reserve $14k",
    evidence: "90-day forecast shows $13.9k shortfall.",
    impact: -14_000,
    horizon: "90 days",
    confidence: 92,
    risks: "Reduces spendable cash.",
    owner: "Christin",
    approval: "Rose",
    status: "open",
  },
  {
    ...
    title: "Automate late-fee application",
    evidence: "$34.8k past 30 days; 46-day median lag on Meridian.",
    impact: 4_200,
    horizon: "30 days",
    confidence: 90,
    risks: "Client friction on first application.",
    owner: "Christin",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-011",
    category: "delay_hire",
    title: "Delay Fulfillment hire 60 days",
    evidence: "Turnaround < 4 days achieved; capacity slack 22%.",
    impact: 22_400,
    horizon: "60 days",
    confidence: 68,
    risks: "Capacity crunch if new client onboards.",
    owner: "Rose",
    approval: "Rose",
    status: "open",
  },
  {
    id: "R-012",
    category: "increase_investment",
    title: "Grow Command Center adoption",
    evidence: "ROI 3.8x · influences $240k revenue · 100% adoption.",
    impact: 84_000,
    horizon: "180 days",
    confidence: 72,
    risks: "Development capacity.",
    owner: "Rose",
    approval: "Rose",
    status: "open",
  },
...
export const EMERGING_RISKS = [
  {
    ...
    label: "AI tools growing 2.9x revenue growth",
    detail: "3.2% of revenue · target 2.0%",
  },
  {
    severity: "medium" as const,
    label: "Blue Harbor scope drift",
    detail: "Unprofitable · scope review needed",
  },
  {
    severity: "medium" as const,
    label: "Bonus reserve 90-day gap",
    detail: "$13.9k shortfall projected",
  },
