...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { title: "Company Workspace", to: "/apex/company", icon: LayoutDashboard, keywords: ["executive", "apex", "company", "governance"] },
    ],
  },
  {
    id: "accounting",
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Pilot Simulation", to: "/admin/pilot-simulation", icon: Rocket, badge: "M12", badgeTone: "brand", keywords: ["pilot", "simulation", "fictional", "lifecycle", "walkthrough"] },
      { title: "Production Review", to: "/admin/production-review", icon: ShieldCheck, badge: "M12", badgeTone: "brand", keywords: ["review", "cutover", "security", "accounting", "integration", "intelligence", "migration"] },
...
export const CHILD_ONLY_ROUTES: NavItem[] = [
  ...
  { title: "Opportunity Engine", to: "/apex/opportunities", icon: Target, hidden: true, keywords: ["opportunity", "recovery", "savings", "apex"] },
  { title: "Opportunity Detail", to: "/apex/opportunities/$id", icon: Target, hidden: true },
  { title: "Financial DNA", to: "/apex/financial-dna", icon: Activity, hidden: true, keywords: ["dna", "trace", "dollar", "flow", "apex"] },
  { title: "Financial DNA Path", to: "/apex/financial-dna/$id", icon: Activity, hidden: true },
  { title: "Financial Timeline", to: "/apex/timeline", icon: CalendarClock, hidden: true, keywords: ["timeline", "history", "chronology", "apex"] },
  { title: "Timeline Event", to: "/apex/timeline/$id", icon: CalendarClock, hidden: true },
  { title: "Relationship Graph", to: "/apex/relationship-graph", icon: Workflow, hidden: true, keywords: ["graph", "relationships", "network", "apex"] },
  { title: "Digital Twin", to: "/apex/digital-twin", icon: Bot, hidden: true, keywords: ["twin", "scenario", "simulate", "apex"] },
  { title: "Digital Twin Scenarios", to: "/apex/digital-twin/scenarios", icon: Bot, hidden: true },
  { title: "Digital Twin Scenario", to: "/apex/digital-twin/scenarios/$id", icon: Bot, hidden: true },
  { title: "Role Workspaces", to: "/apex/workspaces", icon: Users2, hidden: true, keywords: ["role", "workspace", "rose", "accounting", "sales", "operations", "systems", "team", "apex"] },
  { title: "Role Workspace", to: "/apex/workspaces/$role", icon: Users2, hidden: true },
  { title: "AI Personas", to: "/apex/ai-personas", icon: Bot, hidden: true, keywords: ["persona", "advisor", "cfo", "controller", "revenue", "growth", "cash", "operations", "tax", "risk", "executive", "ai", "apex"] },
