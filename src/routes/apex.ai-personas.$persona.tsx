...
export const Route = createFileRoute("/apex/ai-personas/$persona")({
  ...
  notFoundComponent: () => (
    <div className="p-8 text-[13px] text-muted-foreground">
      Unknown persona. Return to <Link to="/apex/ai-personas" className="text-primary underline">AI Personas</Link>.
    </div>
  ),
});
...
function PersonaDetail() {
  ...
  return (
    <ApexPage
      ...
      decision={persona.questions[0]}
    >
      <div className={cn("rounded-2xl border border-white/10 bg-gradient-to-r p-5 text-white", persona.theme.gradient)}>
