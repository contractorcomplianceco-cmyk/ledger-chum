        ...
        <Card className="border-border/70 p-0">
          ...
          {AUTOMATION_RULES.map((r) => (
            ...
            >
              ...
              <span
                className={cn("text-[11.5px] font-medium", RULE_CATEGORY_META[r.category].tone)}
              >
    ...
    <Card className="border-border/70 p-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className={cn(
            "rounded-full border px-2 py-0.5 text-[10.5px] font-semibold",
            RULE_STATUS_META[rule.status].tone,
          )}
        >
      ...
      <dl className="mt-4 space-y-2 text-[12.5px]">
        ...
        <div className="flex gap-4 pt-1">
          ...
          <div>
            ...
            <div className="font-tabular text-lg font-bold text-destructive">
              {rule.failureCount}
            </div>
          </div>
          <div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-1.5">
        <Button size="sm" variant="outline" className="h-8">
          <Play className="mr-1 h-3.5 w-3.5" /> Test mode
        </Button>
        <Button size="sm" variant="outline" className="h-8">
          <Pause className="mr-1 h-3.5 w-3.5" /> Pause
        </Button>
        <Button size="sm" variant="outline" className="h-8">
          <History className="mr-1 h-3.5 w-3.5" /> Audit history
        </Button>
