  ...
  return (
    <AppShell>
      <PageHeader
        ...
        description="Convert accepted estimates directly into pre-allocated invoices."
        actions={
            ...
            <tbody className="divide-y divide-border/60">
              {ESTIMATES.map((e) => (
                <tr key={e.id} className="hover:bg-muted/30">
                  ...
                  <td className="px-2 py-2.5 text-right font-tabular font-semibold text-foreground">{currencyPrecise(e.total)}</td>
                  ...
                  <td className="px-2 py-2.5 text-right">
                    {e.status === "accepted" && (
                      <Button
                        ...
                        disabled
                        title="Estimate → invoice conversion arrives in a later phase"
                      >
