    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="text-[13px] text-muted-foreground">
          ...
          active policies enforcing receipts, thresholds, attribution, and duplicates.
        </div>
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_420px]">
              ...
              {POLICIES.map((p) => {
                ...
                return (
                  <tr
                    ...
                    className={cn(
                      "cursor-pointer",
                      selected.id === p.id ? "bg-brand/5" : "hover:bg-muted/30",
                    )}
                  >
        ...
        <Card className="border-border/70 p-5">
          <div className="flex items-center gap-2">
            {(() => {
              const Icon = SEV_ICON[selected.severity];
              return <Icon className={cn("h-4 w-4", SEV_TONE[selected.severity])} />;
            })()}
          ...
          <div className="mt-4">
            ...
            <div className="mt-1">
              <PolicyBadge result={selected.action} />
            </div>
          </div>
