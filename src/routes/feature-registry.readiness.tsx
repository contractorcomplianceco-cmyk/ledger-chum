    ...
    return (
      ...
      >
        <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <KpiCard label="V1 designed or built" value={v1Built} sub={`${readinessPct}% covered by mocks or design`} />
          <KpiCard label="V1 blocked" value={v1Blocked} sub="Requires legal / integration / backend" />
        ...
        <Card className="border-border/70 p-4 text-[12px] text-muted-foreground">
          ...
          <ul className="mt-1 list-disc space-y-1 pl-5">
            <li>Every V1 feature must have Christin or Carmen review recorded before parallel-run.</li>
            <li>Backend, Supabase, and auth changes are explicitly excluded from this planning phase.</li>
            <li>Owner Transactions, Profit Sharing, Investor Distributions, and Check Writing require legal + tax review before implementation.</li>
