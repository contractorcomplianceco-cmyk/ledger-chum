  ...
  return (
    ...
    >
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <KpiCard
          label="Projected bonuses"
          value={BONUS_KPIS.projected}
          icon={Gift}
          tone="violet"
          delta={4.2}
          trend="up"
        ...
        <KpiCard
          ...
          value={BONUS_KPIS.awaitingVerification}
          icon={Clock}
          tone="cyan"
          delta={1.2}
          trend="up"
        ...
        <KpiCard
          ...
          value={BONUS_KPIS.awaitingApproval}
          icon={ShieldCheck}
          tone="mint"
          delta={-2.4}
          trend="down"
        ...
        <KpiCard
          ...
          value={BONUS_KPIS.approvedUnpaid}
          icon={Check}
          tone="violet"
          delta={3.4}
          trend="up"
      ...
      <p className="text-[11px] italic text-muted-foreground">
        Projected, earned, approved, payable, and paid are tracked as distinct states. Chargebacks
        trigger holdback release delay; reversals produce clawback status.
      </p>
    </IntelligencePage>
  );
}
