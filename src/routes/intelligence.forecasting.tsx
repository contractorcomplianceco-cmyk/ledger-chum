    ...
    >
      ...
      <section className="grid gap-4 xl:grid-cols-4">
        <SummaryCard
          ...
          value={currency(data.reduce((s, r) => s + r.revenue, 0))}
        />
        <SummaryCard
          label="6-month profit"
          value={currency(endProfit)}
          tone={endProfit >= 0 ? "success" : "destructive"}
        />
      ...
      <Card className="border-border/70 p-4">
        ...
        <p className="mt-0.5 text-[11px] text-muted-foreground">
          Text summary: revenue trend {scenario === "revenue_decline" ? "declines" : "grows"},
          expenses {scenario === "tech_reduction" ? "decline" : "grow modestly"}, profit ends at{" "}
          {currency(endProfit)}.
        </p>
      ...
      <Card className="border-border/70 p-4">
        ...
        <p className="mt-2 text-[10.5px] italic text-muted-foreground">
          Forecast values are demonstration mock data.
        </p>
      </Card>
    </IntelligencePage>
  );
