      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-[13px] text-muted-foreground">
            Subscriptions, retainers, and monthly compliance schedules.
          </p>
        </div>
        <Button size="sm">
        ...
        {RECURRING.map((r) => {
          ...
          return (
            <Card
              key={r.id}
              className={cn(
                "border border-border/70 bg-surface p-4 shadow-card",
                !r.active && "opacity-70",
              )}
            >
              ...
              <div className="mt-3 flex items-baseline justify-between">
                <div>
                  ...
                  <div className="font-tabular text-[20px] font-bold text-foreground">
                    {currency(r.amount)}
                  </div>
                </div>
              ...
              <div className="mt-3 flex items-center gap-2 text-[12px] text-muted-foreground">
                <CalendarClock className="h-3.5 w-3.5" /> Next run {r.nextRun} · {r.runCount} runs
                completed
              </div>
